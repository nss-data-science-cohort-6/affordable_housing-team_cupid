...
```{r}
simple_regression_model <- lm(amount ~ square_footage +  age + group + ownerdate + tract, data = pd_within_mi_sales)
...
```{r}
simple_regression_model_log <- lm(log(amount) ~ square_footage +  age + group + ownerdate + tract, data = pd_within_mi_sales)
